...
const STEPS = ['Election участка', 'Details собственности', 'Verification и подача'];
    ...
    return (
      <div className="p-6 max-w-[900px] mx-auto">
        <div className="bg-destructive/10 text-destructive border border-destructive/20 rounded-lg p-4">
          Only citizensе могут регистрировать right собственности.
        </div>
      </div>
    );
  }
    ...
    <div className="p-6 max-w-[900px] mx-auto space-y-6">
      <div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-3xl font-bold">Registration права собственности</h1>
        ...
        <CardContent className="pt-6 space-y-6">
          {activeStep === 0 && (
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">Plot должен быть в кадастровой systemе</p>
              </div>
              <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-3 flex gap-2">
                <AlertTriangle className="h-5 w-5 text-yellow-600 shrink-0 mt-0.5" />
                <p className="text-sm"><strong>Примечание:</strong> Search участков будет добавлен позже.</p>
              </div>
            </div>
          )}
          ...
          {activeStep === 1 && (
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input placeholder="Byкупка, Наследование, Дарение..." value={acquisitionMethod} onChange={(e) => setAcquisitionMethod(e.target.value)} />
              </div>
              <div className="space-y-2">
          ...
          {activeStep === 2 && (
            <div className="space-y-4">
              ...
              <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-3 flex gap-2">
                <Info className="h-5 w-5 text-blue-500 shrink-0 mt-0.5" />
                <p className="text-sm text-muted-foreground">Record будет внесена в блокчейн ALTAN.</p>
              </div>
            </div>
          )}
          ...
          <div className="flex justify-between pt-4">
            ...
            {activeStep === STEPS.length - 1 ? (
              <Button className="bg-green-600 hover:bg-green-700" onClick={handleSubmit} disabled={!canProceed() || submitting}>
                ...
                {submitting ? 'Registration...' : 'Bygive'}
              </Button>
            ) : (
