...
contract NotaryHub {
    ...
    function issueArbanJoinDoc(
        ...
        if (arbanRegistry == address(0) || citizenRegistry == address(0) || leaderCitizenAccount == address(0)) revert ZeroAddress();
...
docAddress = address(doc);
        ...
        emit ArbanJoinDocIssued(docId, arbanId, docAddress, leaderCitizenAccount, minSignatures, docHash);
    }
