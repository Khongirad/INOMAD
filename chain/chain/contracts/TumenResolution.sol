...
interface IStructureRegistryTu {
...
contract TumenResolution {
    IStructureRegistryTu public immutable registry;
    ...
    event Finalized(uint256 indexed tumenId);
    ...
    constructor(address registry_, uint256 tumenId_, bytes32 docHash_, address notary_) {
        registry = IStructureRegistryTu(registry_);
        tumenId = tumenId_;
        docHash = docHash_;
        notary = notary_;
    }
