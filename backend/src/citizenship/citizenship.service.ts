 ...
 *
 * Ключевые принципы:
 * 1. Коренной народ (INDIGENOUS) — источник власти, право голоса в Земельном Фонде
 ...
 * 4. Некоренные граждане (CITIZEN) — полноценные граждане с правом владения землёй,
 *    но не могут отчуждать/продавать/арендовать иностранцам
 * 5. Жители (RESIDENT) — зарегистрированы, но не приняты
 * 6. Иностранцы (FOREIGNER) — только аренда через Земельный Фонд
 */
@Injectable()
