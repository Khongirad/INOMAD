 ...
 *
 * Ключевые принципы:
 * 1. Коренной народ (INDIGENOUS) — ЕДИНСТВЕННЫЙ обладатель исключительного земельного
 *    права, источник власти, ЕДИНСТВЕННЫЙ участник Хурала (законодательная ветвь)
 * 2. Исключительное земельное право передаётся ТОЛЬКО по мужской линии (отец → сын)
 * 3. Если нет сына — право возвращается в Государственный Земельный Фонд
 * 4. Гражданин (CITIZEN) — полноценный гражданин БЕЗ исключительного земельного права,
 *    может вступить в Арбан/создать свой, участие в правительстве, банках, судах.
 *    НЕ МОЖЕТ вступить в Хурал — Хурал только для коренных.
 * 5. Временный вид на жительство (PROVISIONAL) — разрешение на временное проживание (ВНЖ)
 * 6. Жители (RESIDENT) — зарегистрированы, но не приняты в гражданство
 * 7. Иностранцы (FOREIGNER) — только аренда земли через Государственный Земельный Фонд
 *
 * Путь иностранца к гражданству:
 *   FOREIGNER → PROVISIONAL (ВНЖ) → RESIDENT → сдача экзаменов + клятва → CITIZEN
 *   (после получения гражданства может вступить в Арбан или создать свой)
 */
@Injectable()
