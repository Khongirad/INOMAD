 ...
 *    права, источник власти, право голоса в Земельном Фонде и Хурале
 ...
 *    участие в исполнительной, судебной и банковской ветвях власти
 * 5. Натурализованный (NATURALIZED) — получил гражданство после экзаменов и клятвы
 * 6. Временный вид на жительство (PROVISIONAL) — разрешение на временное проживание (ВНЖ)
 * 7. Жители (RESIDENT) — зарегистрированы, но не приняты в гражданство
 * 8. Иностранцы (FOREIGNER) — только аренда земли через Государственный Земельный Фонд
 *
 * Натурализация иностранца:
 *   FOREIGNER → PROVISIONAL (ВНЖ) → RESIDENT → сдача экзаменов + клятва →
 *   NATURALIZED → голосование коренных → CITIZEN
 */
@Injectable()
