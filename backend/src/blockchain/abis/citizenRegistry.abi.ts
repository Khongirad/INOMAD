...
export const CitizenRegistry_ABI = [
  ...
  'function metaOf(uint256 seatId) view returns (bytes32 nationId, uint256 arbadId, uint256 provinceId, uint256 districtId, uint256 cityId, uint256 registrationDate, bool exists)',
  
  // Write functions (for future use)
  'function registerSelf(bytes32 nationId, uint256 arbadId, uint256 provinceId, uint256 districtId, uint256 cityId, bytes32 ethicsProofHash, bytes32 identityProofHash) returns (uint256)',
